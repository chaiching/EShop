...
<body>
    ...
    <div class="container">
        ...
        try {
            ...
            $query = "SELECT id, customer_username, order_time FROM orders WHERE id = ? LIMIT 0,1";
        ...
        if ($_POST) {
            try {
                ...
                if ($flag == 1) {
                    ...
                    SET customer_username=:customer_username WHERE id = :id";
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}"); ?>" method="post">
            <table class='table table-hover table-responsive table-bordered'>
                <tr>
                    ...
                    <td><input type='text' name='name' value="<?php echo htmlspecialchars($customer_username, ENT_QUOTES);  ?>" class='form-control' /></td>
                </tr>
                <tr>
                    <td>Order Time</td>
